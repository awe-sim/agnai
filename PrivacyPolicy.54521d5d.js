...
parcelRegister("aZPGc", function(module, exports) {

$parcel$defineInteropFlag(module.exports);

$parcel$export(module.exports, "default", () => $46b8c0367f84dba7$export$2e2bcd8739ae039);
...
const $46b8c0367f84dba7$var$_tmpl$ = /*#__PURE__*/ (0, $f4ihl.template)(`<div><div class="markdown flex flex-col gap-4"></div></div>`, 4);
const $46b8c0367f84dba7$var$text = `
...
`;
const $46b8c0367f84dba7$var$PrivacyPolicyPage = ()=>{
    return (()=>{
        const _el$ = $46b8c0367f84dba7$var$_tmpl$.cloneNode(true), _el$2 = _el$.firstChild;
        (0, $f4ihl.insert)(_el$, (0, $6TTLi.createComponent)((0, $iNI0B.default), {
            get title () {
                return "Agnaistic Privacy Policy";
            }
        }), _el$2);
        (0, $f4ihl.effect)(()=>_el$2.innerHTML = (0, $i5LtX.markdown).makeHtml($46b8c0367f84dba7$var$text));
        return _el$;
    })();
};
var $46b8c0367f84dba7$export$2e2bcd8739ae039 = $46b8c0367f84dba7$var$PrivacyPolicyPage;

});


//# sourceMappingURL=PrivacyPolicy.54521d5d.js.map
