...
parcelRegister("eQtSp", function(module, exports) {

$parcel$defineInteropFlag(module.exports);

$parcel$export(module.exports, "default", () => $cbe9876b5e8c7969$export$2e2bcd8739ae039);
...
const $cbe9876b5e8c7969$var$_tmpl$ = /*#__PURE__*/ (0, $f4ihl.template)(`<div><div class="markdown flex flex-col gap-4"></div></div>`, 4);
const $cbe9876b5e8c7969$var$text = `
...
`;
const $cbe9876b5e8c7969$var$TermsOfServicePage = ()=>{
    return (()=>{
        const _el$ = $cbe9876b5e8c7969$var$_tmpl$.cloneNode(true), _el$2 = _el$.firstChild;
        (0, $f4ihl.insert)(_el$, (0, $6TTLi.createComponent)((0, $iNI0B.default), {
            get title () {
                return "Agnaistic Terms of Service";
            }
        }), _el$2);
        (0, $f4ihl.effect)(()=>_el$2.innerHTML = (0, $i5LtX.markdown).makeHtml($cbe9876b5e8c7969$var$text));
        return _el$;
    })();
};
var $cbe9876b5e8c7969$export$2e2bcd8739ae039 = $cbe9876b5e8c7969$var$TermsOfServicePage;

});


//# sourceMappingURL=TermsOfService.a687830c.js.map
